...
IMU_PARAM=$(ros2 pkg prefix pure_imu_undistortion)/share/pure_imu_undistortion/param/param_mid.yaml
ODOM_PARAM=$(ros2 pkg prefix pure_lidar_gyro_odometer)/share/pure_lidar_gyro_odometer/param/param_mid.yaml
